    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8">
          ...
          <p className="text-sm text-gray-400 mb-6">Manage registered businesses and approvals</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3.5 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="mylogestic"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3.5 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
                  placeholder="••••••••"
                />
